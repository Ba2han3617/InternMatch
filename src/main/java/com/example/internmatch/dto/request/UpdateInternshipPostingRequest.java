...
@Schema(description = "Staj ilanı güncelleme isteği - yalnızca gönderilen alanlar güncellenir")
public class UpdateInternshipPostingRequest {

    @Size(min = 3, max = 150, message = "Başlık 3-150 karakter arasında olmalıdır")
    @Schema(description = "İlan başlığı", example = "Senior Backend Developer Stajyeri")
    ...
    @Schema(description = "Şehir", example = "Ankara")
    private String city;

    @Schema(description = "Çalışma modeli", example = "REMOTE")
    ...
    @Schema(description = "Staj bitiş tarihi", example = "2027-01-31")
    ...
    @Schema(description = "Kontenjan sayısı", example = "5")
